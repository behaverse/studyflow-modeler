...
import {
  ...
  isPrimitiveTypeRef,
  type YamlDoc,
} from '@/core/codec/common';
import { elementListProperty } from '@/core/codec/foldings/element-list';
import { keyedMapToList } from '@/core/codec/foldings/id-keyed';
import { extractInlineDi, type DiType } from '@/core/codec/foldings/inline-di';
import {
  foldInlineBody,
  foldInlineValue,
  isYamlValueProperty,
  ...
  yamlBodyProperty,
} from '@/core/codec/foldings/yaml-body';
