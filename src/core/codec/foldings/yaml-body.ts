 ...
 * `YAMLString` body property; `studyflow:additionalArguments` carries it in a value-typed
...
/** True when a property is a value-typed (non-body) `YAMLString`, e.g. `studyflow:additionalArguments`. */
...
/**
 * FOLD (serialize): a value-typed YAML property (`studyflow:additionalArguments`) inlines its
