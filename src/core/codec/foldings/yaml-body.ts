 ...
 * `YAMLString` body property; `exec:additionalArguments` carries it in a value-typed
...
/** True when a property is a value-typed (non-body) `YAMLString`, e.g. `exec:additionalArguments`. */
...
/**
 * FOLD (serialize): a value-typed YAML property (`exec:additionalArguments`) inlines its
