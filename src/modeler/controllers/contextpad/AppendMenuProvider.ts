import { getCatalog, HIDDEN_SCHEMA_TYPES, type TypeEntry } from '@/core/catalog';
import { buildBusinessObject } from '@/modeler/models/shape/buildBusinessObject';
import type { AutoPlace, Create, ElementFactory, Injector, PopupMenu, Rules } from '@/modeler/infra/bpmn-js.d';
