...
import { ExamplesButton } from './actions/Examples';
      ...
      <div className="hidden md:flex items-center gap-0.5">
        ...
        <Menu as="div" title="HelpMenu">
          ...
          <MenuItems anchor="bottom start" className={dropdownCls}>
            <MenuItem>
              <a href={URLS.docs} target="_blank" className={`block ${itemCls}`}>Docs</a>
            </MenuItem>
            <MenuItem>
              <a href={URLS.githubRepo} target="_blank" className={`block ${itemCls}`}>GitHub</a>
            </MenuItem>
          </MenuItems>
        </Menu>
