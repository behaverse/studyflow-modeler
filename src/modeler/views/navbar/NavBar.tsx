...
import { SimulateButton } from '@/modeler/views/navbar/actions/Simulate';
import { RunButton } from '@/modeler/views/navbar/actions/Run';
import { CommandPalette, OPEN_PALETTE_SHORTCUT_LABEL } from '@/modeler/views/dialogs';
import { useDiagramName } from '@/modeler/views/navbar/useDiagramName';
import { navbar, navBurgerBtnCls, navDividerCls } from '@/modeler/infra/styles';
