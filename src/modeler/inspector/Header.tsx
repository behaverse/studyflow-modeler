...
import { StudyflowElement, getAttribute } from '@/lib/core/extensions';
...
function getTypeName(element: any): string {
  return StudyflowElement.fromBusinessObject(element).extensionType || getBusinessObject(element)?.$type || element.type;
}
