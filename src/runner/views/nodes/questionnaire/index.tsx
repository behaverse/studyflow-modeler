...
import { validateQuestionnaire } from '@/runner/models/nodes/questionnaire/validation';
import { nodeStyles } from '@/runner/infra/nodes/styles';
import { registerNode } from '@/runner/controllers/nodes/registry';
import { getInstrument, type InstrumentDefinition } from '@/runner/models/nodes/questionnaire/instruments';
