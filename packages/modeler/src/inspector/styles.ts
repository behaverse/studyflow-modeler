import { surface, shadow, border, radius, tooltip } from '@modeler/ui/styles';
...
/* ponytail: inspector fields wear a 0.20 border, under the 3:1 control minimum --
   the cream-200 fill, label and focus ring carry identification; darken if audited. */
export const field = {
  field: 'mx-2 pb-2',

  label: 'flex items-center justify-between text-sm font-semibold',
  labelActions: 'flex items-center gap-1',
  labelAddBtn: 'w-5 h-5 flex items-center justify-center rounded text-stone-500 hover:text-stone-900 hover:bg-black/[0.05] cursor-pointer',
  ...
  helpIcon: `${ICONS.help} text-base text-stone-500 cursor-help`,
  helpTooltip: `fixed w-48 ${tooltip} text-xs p-2 z-[260]`,
  ...
  select: 'appearance-none px-2 py-1 pr-8 w-full rounded-md border border-black/[0.20] bg-cream-200 text-sm/6 text-stone-900 focus:outline-2 focus:-outline-offset-2 focus:outline-[hsl(205,100%,45%)]',
  selectChevron: 'group iconify bi--caret-down pointer-events-none absolute top-1.5 right-2.5 text-stone-500',

  comboInput: 'appearance-none px-2 py-1 pr-8 w-full rounded-md border border-black/[0.20] bg-cream-200 font-mono text-sm/6 text-stone-900 placeholder-stone-400 focus:outline-2 focus:-outline-offset-2 focus:outline-[hsl(205,100%,45%)]',
  ...
  comboChevronIcon: `${ICONS.caretDown} text-xs`,
  comboOptions: `z-[240] mt-1 w-[var(--input-width)] max-h-56 overflow-auto rounded-md border border-black/[0.08] bg-cream-100 ${shadow.menu} py-1 focus:outline-none [--anchor-gap:4px]`,
  ...
  listboxBtn: 'appearance-none px-2 py-1 pr-8 w-full text-left rounded-md border border-black/[0.20] bg-cream-200 text-sm/6 text-stone-900 focus:outline-2 focus:-outline-offset-2 focus:outline-[hsl(205,100%,45%)] cursor-pointer',
  listboxOptions: `z-[240] mt-1 w-[var(--button-width)] max-h-56 overflow-auto rounded-md border border-black/[0.08] bg-cream-100 ${shadow.menu} py-1 focus:outline-none [--anchor-gap:4px]`,
  labelMenuOptions: `z-[240] mt-1 min-w-48 max-w-[min(20rem,calc(100vw-2rem))] w-max max-h-56 overflow-auto rounded-md border border-black/[0.08] bg-cream-100 ${shadow.menu} py-1 focus:outline-none [--anchor-gap:4px]`,

  booleanRow: 'flex items-center justify-between',
  booleanGroup: 'flex items-center gap-2',
  checkbox: 'group block size-4 rounded border border-black/[0.45] bg-cream-200 data-[checked]:bg-stone-900 data-[checked]:border-stone-900',
...
export const codeEditor = {
  ...
  modalTitle: 'text-base font-semibold tracking-tight text-stone-900',
