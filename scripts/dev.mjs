 ...
 * runner on :5174. The modeler proxies `/run` (which includes the Unity build
 * at /run/assessment-unity) and `/api/llm` to the runner so
 * http://localhost:5173 serves the whole site on
