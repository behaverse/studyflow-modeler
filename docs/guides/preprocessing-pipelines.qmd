...
Ready-made preprocessing templates -- *EEGPrep* and *fMRIPrep*, both `Map` operations that delegate to a pinned container -- ship with the optional `eeg` schema; see [Extensions](../reference/extensions.qmd).
