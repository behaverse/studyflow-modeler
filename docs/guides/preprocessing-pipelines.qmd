...
Ready-made preprocessing templates -- an fMRIPrep task (`PreprocessfMRI`) and an EEGPrep subprocess (`PreprocessEEG`) -- ship with the optional `omniprocess` schema; see [Extensions](../reference/extensions.qmd).
