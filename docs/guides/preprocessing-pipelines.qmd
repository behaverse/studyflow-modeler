...
In the modeler palette these elements use Title Case names (Map, Filter, Reduce, ...) while the underlying `operationType` values serialized in the XML are lowercase (`map`, `filter`, `reduce`, ...) -- see [Data](../reference/data.qmd).
