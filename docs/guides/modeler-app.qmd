...
7. Save your diagram using the "Save As..." option in the "File" menu and pick a format: "Studyflow" writes the native YAML file (`*.studyflow`); the same menu also offers BPMN 2.0 XML, images (SVG, PNG), and the other export formats (LinkML, NIDM, ARTEM-IS).
