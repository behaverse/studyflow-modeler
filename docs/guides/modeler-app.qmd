...
7. Save your diagram using the "Save As..." option in the "File" menu. The diagram will be saved as a YAML file (`*.studyflow`). Alternatively, you can export the diagram as an image using the export options.
