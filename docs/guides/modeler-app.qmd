...
Every way a diagram leaves the app is one dialog -- *File &rarr; Export...* -- with the native `.studyflow` file as the default format rather than a separate "save" menu (see `src/modeler/models/exporters/`):
