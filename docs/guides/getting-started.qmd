...
Studyflow is a visual language for defining research workflows and scientific experiments. It builds on <abbr title="Business Process Model and Notation">BPMN</abbr> and adds research-focused components to make it accessible to scientists.

This page is a quick, streamlined path to creating your first studyflow diagram. After completing this guide, you can explore more advanced topics in the [reference](../reference/spec.qmd) section.
