...
| Type | Drawn as | Means | Attributes |
|:--|:--|:--|:--|
| `Actor` | `bpmn:Participant` | Who or what takes part: human, model, software agent, or instrument. A pool when it has steps of its own, a band on a cognitive task when it only takes that task. | `actorType` (`human`, `llm`, `agent`, `instrument`), `identifier`, `promptTemplate` |
