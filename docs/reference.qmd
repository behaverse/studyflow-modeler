...
The YAML and the XML convert into each other losslessly, so a round trip returns byte-identical text and a version-control diff shows your edits and nothing else. Here is a complete, runnable study:
