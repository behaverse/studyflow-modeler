...
That is [`minimal_study.studyflow.yaml`](assets/examples/minimal_study.studyflow.yaml) in full. There is no geometry in it: the layout follows from `sourceRef` and `targetRef`, and the modeler only saves geometry once you rearrange things by hand.
