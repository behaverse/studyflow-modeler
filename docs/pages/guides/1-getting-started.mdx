...
This page is a quick, streamlined path to creating your first studyflow diagram. After completing this guide, you can explore more advanced topics in the [reference](../category/reference/) section.
...
For a detailed overview of the studyflow language, refer to the [reference](../category/reference/) section.
</Admonition>
...
These icons extend the standard BPMN icons. For a complete list, see [*Reference &rsaquo; Elements*](reference/2-elements.md).
