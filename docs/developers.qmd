...
| the Python runners | run the data-facing steps — the ones bound to software | [`packages/cli`](https://github.com/behaverse/studyflow-modeler/tree/main/packages/cli) |
