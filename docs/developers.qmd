...
| the skills | one folder each, declared by its `SKILL.md`: a BPMN extension (vocabulary), runners that execute it per runtime, examples, tests; any part may be missing | [`skills`](https://github.com/behaverse/studyflow-modeler/tree/main/skills) |
