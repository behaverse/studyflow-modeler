...
Describing experimental research can be complex and ambiguous. Studyflow is a visual language for describing scientific workflows in a way that is both human-understandable and machine-readable. It extends BPMN[^bpmn] so researchers can model experiments, data collection, analysis, and reporting in a single formal diagram.
...
<figure class="centered max-w-2xl">
  ...
  <figcaption>
    A simple studyflow diagram showing the experimental design of a study as a series of events, tasks, and decisions.
  </figcaption>
</figure>
...
- **Get started**: walk through a complete worked example on [Get started](get-started.qmd).
...
- **Specification**: read [Why Studyflow](reference/why-studyflow.qmd), [Studyflow vs BPMN](reference/studyflow-vs-bpmn.qmd), and the [Specification](reference/spec.qmd).
