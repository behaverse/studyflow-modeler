...
description: Selective rendering for manuscripts, supplements, and presentations
lightbox: true
categories: [Experimental, Pipeline]
---
...
Here is an example that illustrates how a single studyflow specification can be visualized in different ways for publication:

1. as a comprehensive study workflow including all procedural details,
2. as a simplified figure for the main manuscript, and
3. as an interactive figure for online supplements or presentations.
