...
3. **Consent** -- a `Start Event` with `consentFormUri` set to the consent form's URL, gating entry into the rest of the flow.
...
- [Cognitive tasks](cognitive-tasks.qmd) -- modeling trial-level structure within a task.
