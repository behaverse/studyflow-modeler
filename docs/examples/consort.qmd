---
title: CONSORT
subtitle: Reporting randomized controlled trials as a studyflow
lightbox: true
...
The annotated studyflow below uses even more concise elements and iconography to describe the same flow using error handling feature. The left path (group 1) is enhanced with studyflow elements. The right path (group 2) uses a more traditional approach with texts, boxes, and arrows.
...
The studyflow diagram can also include additional metadata such as colors, checklists, and timelines to enhance readability. Since the diagram is machine-readable, it can also be used to generate reports or simulate the flow of participants through the experiment.
