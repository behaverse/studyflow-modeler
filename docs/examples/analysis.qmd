...
description: End-to-end analysis from raw trial data to summary statistics
lightbox: true
categories: [Pipeline]
---
...
Three reasons a diagram beats prose-only documentation here:
...
- [Preprocessing pipelines](../guides/preprocessing-pipelines.qmd) — how to use `Map`, `Filter`, `Reduce`, `Group`.
- [Attach a schema to a dataset](../guides/attach-schema.qmd) — schema-attached datasets.
