...
Studyflow can be used to create checklists that adhere to these guidelines, making it easier to ensure that all necessary information is included in the diagram. Any element can carry a checklist: a `bpmn:documentation` entry marked with `studyflow:checklist`, whose body is a markdown list of task items (`- [ ]` / `- [x]`). Each item can be linked to a specific guideline section and to an element in the studyflow. Because the checklist lives in the diagram file, it is machine-readable and can be used to generate compliance reports.

The modeler renders these checklists through the **Checklist view** (*View As &rarr; Checklist* in the command palette) -- see [Views](../reference/views.qmd). For worked sources, see the CONSORT example (`docs/assets/img/consort2025.studyflow`, walked through in [CONSORT](consort.qmd)) and the SPIRIT timeline below.
