...
- `studyflow.moddle.yaml` — the core Studyflow language.
- `behaverse.moddle.yaml`, `datatrove.moddle.yaml`, `galea.moddle.yaml`, `omniprocess.moddle.yaml` — domain extensions.
