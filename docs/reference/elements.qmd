...
<div class="grid grid-cols-2 gap-4">
  ...
  <figure class="centered" style="max-width: 240px;">
...
<div class="grid grid-cols-2 gap-4">
  <figure class="centered">
    ...
    <figcaption>
      **Data Store** and **Dataset** persist data (e.g., events, trials, etc) and facilitate the integration of standard data models. See [the **Data** reference page](data.qmd) for more details.
    </figcaption>
  </figure>
