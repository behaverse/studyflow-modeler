...
- `get-started/` — single read-along tutorial.
...
- `examples/` — domain-specific worked examples, tagged Experimental / Pipeline / Both.
...
- Example pages have a `categories:` list with one or more of `Experimental`, `Pipeline`, `Both`.
