import {
  ...
  ToggleMode.prototype._init = function() {
    this._container = domify(`
        <div class="bts-toggle-mode bts-toggle bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded items-center">
            <span>Simulate</span>
        </div>
    `);
